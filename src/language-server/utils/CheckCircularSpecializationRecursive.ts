...
const checkCircularSpecializationRecursive = (actualElement: ClassElement, verificationList: ClassElement[], accept: ValidationAcceptor): void => {
    actualElement.specializationEndurants.forEach(specializationItem => {
      ...
      if (specializationExists) {
        ...
        accept('error', 'There is a ciclic specialization. Please review all Elements specializations', { node: actualElement, property: 'specializationEndurants'})
        accept('error', 'There is a ciclic specialization. Please review all Elements specializations', { node: specItem, property: 'name'})
        return
      } 
