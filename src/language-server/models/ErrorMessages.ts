export enum ErrorMessages {
    cyclicSpecialization = "There is a cyclic specialization. Please review all Elements specializations (including those in generalization sets) from your model",
