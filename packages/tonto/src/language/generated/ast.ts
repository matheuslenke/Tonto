...
export type TontoTerminalNames = keyof typeof TontoTerminals;

export type TontoKeywordNames =
    | "("
    | ")"
    | "*"
    | ","
...
export type TontoTokenNames = TontoTerminalNames | TontoKeywordNames;
...
export interface Attribute extends langium.AstNode {
    ...
    attributeTypeRef: langium.Reference<DataType>;
...
export interface Cardinality extends langium.AstNode {
...
export interface ClassDeclaration extends langium.AstNode {
    ...
    instanceOf?: langium.Reference<ClassDeclaration>;
    label?: Label;
    name: string;
    ontologicalNatures?: ElementOntologicalNature;
    references: Array<ElementRelation>;
    specializationEndurants: Array<langium.Reference<ClassDeclaration>>;
}
 ...
 */
export interface ContextModule extends langium.AstNode {
...
export interface DataType extends langium.AstNode {
    ...
    specializationEndurants: Array<langium.Reference<DataTypeOrClass>>;
}
...
export interface ElementOntologicalNature extends langium.AstNode {
    readonly $container: ClassDeclaration | DataType;
...
export interface ElementRelation extends langium.AstNode {
    ...
    secondEnd: langium.Reference<DataTypeOrClassOrRelation>;
    secondEndMetaAttributes?: RelationMetaAttributes;
    specializeRelation?: langium.Reference<ElementRelation>;
}
...
export interface EnumElement extends langium.AstNode {
...
export interface GeneralizationSet extends langium.AstNode {
    readonly $container: ContextModule;
    readonly $type: 'GeneralizationSet';
    categorizerItems: Array<langium.Reference<ClassDeclarationOrRelation>>;
    complete: boolean;
    disjoint: boolean;
    generalItem: langium.Reference<ClassDeclarationOrRelation>;
    name: string;
    specificItems: Array<langium.Reference<ClassDeclarationOrRelation>>;
}
...
export interface Import extends langium.AstNode {
    ...
    packageAlias?: string;
    referencedModel: langium.Reference<ContextModule>;
}
...
export interface LanguageLabelItem extends langium.AstNode {
...
export interface OntologicalCategory extends langium.AstNode {
...
export interface RelationMetaAttribute extends langium.AstNode {
    readonly $container: RelationMetaAttributes;
    readonly $type: 'RelationMetaAttribute';
    isConst: boolean;
    isDerived: boolean;
    isOrdered: boolean;
    redefinesRelation?: langium.Reference<RelationMetaAttributes>;
    subsetRelation?: langium.Reference<RelationMetaAttributes>;
}
...
export interface RelationMetaAttributes extends langium.AstNode {
...
export class TontoAstReflection extends langium.AbstractAstReflection {
