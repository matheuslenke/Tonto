export enum ErrorMessages {
    ...
    sortalSpecializesUniqueUltimateSortal = "Every sortal class must specialize a unique Ultimate Sortal (kind, collective, quantity, relator, quality, mode, intrinsicMode, extrinsicMode, type or powertype)",
