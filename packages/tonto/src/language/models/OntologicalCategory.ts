...
const allOntologicalCategories = [...SortalOntoCategories, ...RigidOntoCategories, ...AntiRigidOntoCategories];
...
function getOntologicalCategory(stereotype: string): OntologicalCategoryEnum | undefined {
    switch (stereotype) {
        case "class":
