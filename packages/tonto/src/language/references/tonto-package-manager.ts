...
import { Disposable, DocumentState, LangiumDocument, MultiMap, URI, WorkspaceFolder } from "langium";
import { PackageJson } from "type-fest";
import { CancellationToken } from "vscode";
import { Utils as UriUtils } from "vscode-uri";
import { SystemInfo, SystemUpdateListener, SystemUpdatedEvent } from "../../model-server/types.js";
import { TontoSharedServices } from "../tonto-module.js";
import { Utils } from "../utils/uri-util.js";
import { PackageAstNodeDescription } from "./tonto-ast-node-description.js";
import { QUALIFIED_ID_SEPARATOR } from "./tonto-name-provider.js";
...
export const TONTO_JSON = "tonto.json";

export function isPackageUri(uri: URI): boolean {
    return UriUtils.basename(uri) === TONTO_JSON;
}
...
export class TontoPackageManager {
